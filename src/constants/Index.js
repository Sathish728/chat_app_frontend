export const THEMES = [
  ...
  name: "aurora",
  label: "Aurora",
  colors: ["#f8fafc", "#7dd3fc", "#a78bfa", "#0f172a"],
  },
  {
  name: "midnight",
  label: "Midnight",
  colors: ["#0b1120", "#3b82f6", "#8b5cf6", "#e2e8f0"],
  },
  {
  name: "neonpulse",
  label: "Neon Pulse",
  colors: ["#0f0f1a", "#00f0ff", "#ff00c8", "#ffffff"],
  },
  {
  name: "minty",
  label: "Minty Fresh",
  colors: ["#f0fdfa", "#34d399", "#2563eb", "#0f172a"],
  },
  {
  name: "coralglow",
  label: "Coral Glow",
  colors: ["#fff7ed", "#fb7185", "#f97316", "#1e293b"],
  },
  {
  name: "sapphire",
  label: "Sapphire",
  colors: ["#f8fafc", "#3b82f6", "#6366f1", "#1e293b"],
  },
  {
  name: "onyx",
  label: "Onyx",
  colors: ["#121212", "#10b981", "#3b82f6", "#f5f5f5"],
  },
  {
  name: "blossom",
  label: "Blossom",
  colors: ["#fdf2f8", "#ec4899", "#a78bfa", "#1f2937"],
  },
  {
  name: "oceanbreeze",
  label: "Ocean Breeze",
  colors: ["#f0fdfa", "#14b8a6", "#0284c7", "#0f172a"],
  },
  {
  name: "inferno",
  label: "Inferno",
  colors: ["#1c1917", "#f97316", "#ef4444", "#f5f5f5"],
  },
